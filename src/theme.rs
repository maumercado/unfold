...
pub struct ThemeColors {
    ...
    /// Color used to render the matched substring inline within a key or value
    pub search_highlight_text: Color,
    pub selected: Color,
    pub error: Color,
...
impl ThemeColors {
    pub fn dark() -> Self {
        ThemeColors {
            ...
            search_highlight_text: Color::from_rgb(1.0, 0.85, 0.2),
    ...
    pub fn light() -> Self {
        ThemeColors {
            ...
            search_highlight_text: Color::from_rgb(0.7, 0.35, 0.0),
    ...
    move |_theme: &iced::Theme, status: ButtonStatus| {
        let (bg_color, text_color, border_color) = match status {
            ...
            ButtonStatus::Hovered => (
                colors.btn_bg_hover,
                colors.text_primary,
                colors.btn_border_top,
            ),
            ButtonStatus::Pressed => (
                colors.btn_border_bottom,
...
pub fn button_toggle_style_themed(
    is_active: bool,
    colors: ThemeColors,
) -> impl Fn(&iced::Theme, ButtonStatus) -> button::Style {
    move |_theme: &iced::Theme, status: ButtonStatus| {
        let (bg_color, text_color, border_color) = match (is_active, status) {
            (true, ButtonStatus::Active) => (
                colors.btn_active_bg,
                colors.text_primary,
                colors.btn_active_border,
            ),
            (true, ButtonStatus::Hovered) => (
                colors.btn_active_bg,
                colors.text_primary,
                colors.btn_active_border,
            ),
            ...
            (false, ButtonStatus::Active) => {
                (colors.btn_bg, colors.text_secondary, colors.btn_border_top)
            }
            (false, ButtonStatus::Hovered) => (
                colors.btn_bg_hover,
                colors.text_primary,
                colors.btn_border_top,
            ),
            (false, ButtonStatus::Pressed) => (
                colors.btn_border_bottom,
                colors.text_secondary,
                colors.btn_border_bottom,
            ),
            (_, ButtonStatus::Disabled) => (
                colors.btn_disabled,
                colors.text_secondary,
                colors.btn_disabled,
            ),
